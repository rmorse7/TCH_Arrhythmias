...
def load_label_event(patient_folder_path, excel_file_path, excel_sheet_name='summary', fs=240,
                     ...
                     ppg_features={'st': True, 'dt': True, 'half_width': True, 'two_thirds': True},
                     save_file_path=None):
    ...
    with open(save_file, 'w') as f:
        writer = csv.writer(f)
        #features going to be used
        writer.writerow(
            ['pre_R', 'post_R', 'local_R', 'st', 'dt', 'half_width', 'two_thirds', 'one_beat_ecg_rr_wt_dpb_13',
             'one_beat_ecg_rr_wt_dpb_14', 'one_beat_ecg_rr_wt_dpb_15', 'one_beat_ecg_rr_wt_dpb_16',
             'one_beat_ecg_rr_wt_dpb_17', 'one_beat_ecg_rr_wt_dpb_18', 'one_beat_ecg_rr_wt_dpb_19',
             'one_beat_ecg_rr_wt_dpb_20', 'one_beat_ecg_rr_wt_dpb_21', 'one_beat_ecg_rr_wt_dpb_22',
             'one_beat_ecg_rr_wt_dpb_23', 'one_beat_ecg_rr_wt_dpb_24', 'one_beat_ecg_rr_wt_dpb_25',
             'one_beat_ecg_rr_wt_dpb_26', 'one_beat_ecg_rr_wt_dpb_27', 'label', 'health','patientID'])
            ...
            for block_file in listdir(patient_file_path):
                ...
                if block_start_time <= event_start_time <= event_end_time <= block_end_time:
                    ...
                    if ecg_features['Wavelet']:
                        ...
                        ecg_wt_feature = compute_wavelet_features(ecg_denoise, R_peak_index, windowL=-60, windowR=60,
                                                                  wavelet=family, level=level)
...
#uncomment and specify local path to Waveform Data and Labelled_Events.xlsx file to run. Save to save_file_path folder
#load_label_event('C:/Users/tianq/Documents/dsci535/Waveform Data', 'Labelled_Events.xlsx', excel_sheet_name='Summary', save_file_path='Modeling Data')
