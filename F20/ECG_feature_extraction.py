...
# '''
# This function is used to compute the wavelet descriptor for a beat
# Arguments:
#     beat: the original one beat waveform
#     family: string, the name of wavelet funtion 
#     level: parameter for scale level
# Return:
#     one dimension coefficients at the assigned level
